...
def main(cfg: DictConfig) -> None:
    ...
    assets_manager = AssetsManager(source_path, assets_path, trainer, dataset, optimization, pipeline, gaussians_iterations, mesh_iterations, experiment_name, assets.filter_mesh_objects, assets.fill_mesh_holes, assets.mesh_method, assets.depth_dir)
